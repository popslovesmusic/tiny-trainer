# Save this as 'test_tokenizer.py'
import re

# We will use the final version of the VSLTokenizer class here.
class BaseTokenizer:
...
test_statement = "is_a_star(Sun)"
tokenizer = VSLTokenizer()
tokens = tokenizer.tokenize(test_statement)
print(tokens)